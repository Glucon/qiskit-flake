...
let
  ...
  symengine_130 = pkgs.callPackage ./pkgs/qiskit/symengine_130.nix { };
  pythonEnv = pythonVersion.override {
    packageOverrides = self: super: {
      python_symengine_130 = self.callPackage ./pkgs/qiskit/python_symengine_130.nix {
        inherit symengine_130;
      };
      qiskit = self.callPackage ./pkgs/qiskit { };
      qiskit_1 = self.callPackage ./pkgs/qiskit/qiskit_1.nix {
        python_symengine_130 = self.python_symengine_130;
      };
      qiskit-aer = self.callPackage ./pkgs/qiskit-aer {
        # inherit spdlog_1_9_2 nlohmann_json_3_1_1;
      };
      qiskit-aer_qiskit_1 = self.callPackage ./pkgs/qiskit/qiskit-aer_qiskit_1.nix {
        qiskit_1 = self.qiskit_1;
      };
      qiskit-machine-learning = self.callPackage ./pkgs/qiskit-machine-learning.nix {
        qiskit_1 = self.qiskit_1;
      };
      qiskit-algorithms = self.callPackage ./pkgs/qiskit-algorithms.nix {
        qiskit_1 = self.qiskit_1;
      };
      qiskit-nature = self.callPackage ./pkgs/qiskit-nature.nix {
        qiskit_1 = self.qiskit_1;
      };
    };
  };
